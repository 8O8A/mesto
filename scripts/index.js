...
const buttonCloseAdd = popupAddPhoto.querySelector('.close_add_photo'); //закрыть popup "Добавить фотографию"
const buttonClosePhoto = popupImage.querySelector('.close-image');//закрыть Popup с картинкой
